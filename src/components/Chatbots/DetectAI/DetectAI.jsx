                              ...
                              <div className='flex flex-col gap-16 justify-center mt-4'>
                                ...
                                <div className=' flex justify-center'>
                                  <div className=' w-44 h-44'>
                                    ...
                                    <PlagDonutChart data={
                                      [
                                        { label: 'Detect AI', percentage: 100 -  (plagAnswer[0].answer.match(/\d+/))[0] },
                                        { label: 'Plagiarism', percentage: (plagAnswer[0].answer.match(/\d+/))[0] },
                                      ]
                                    } />
                                  </div>
                                </div>
                                    ...
                                    plagAnswer && (
                                      <div className=" prose text-sm" dangerouslySetInnerHTML={{
                                        __html: plagAnswer[0].answer
                                          ...
                                          .replace(/Similarity: \d+ %/g, '<b>$&</b><br/>')
                                          .replace(/Plagiarism occurred in the following sections:/, '<h3>Plagiarism occurred in the following sections:</h3>')
                                          .replace(/-section: /g, '<br /><br /><b>Section:</b> ')
                                      }} />
