...
const Form = () => {
    return (
        <form action="#" className="space-y-8 border px-10 py-8 rounded-lg shadow-lg shadow-black-500 bg-white">
            ...
            <div className="flex flex-col md:flex-row gap-7 md:gap-10">
                ...
                <div className='flex-1'>
                    ...
                    <input 
                        ...
                        pattern='(d{3})-d{4}-d{3}' 
                        id="phone"
                        className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" placeholder="(201)-1234-1234" required />
                </div>
            </div>
